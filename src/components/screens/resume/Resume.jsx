    ...
    return (
        <div className={s.resume}>
            ...
            <p>
                ...
                my technical skills and experience to benefit my employer and contribute to
                successful projects both today and in the future.
            </p>
            ...
            <section className={s.experience}>
                ...
                <div className={s.right}>
                    ...
                    <ul>
                        <li>Worked on updating the site design and implementing new features</li>
                    </ul>
                </div>
            </section>
            ...
            <section className={s.education}>
                ...
                <h4>2019 - present</h4>
                <p>
                    Coursework: Fundamentals of programming and algorithmization; Object-oriented
                    programming; Databases; Testing; Technology for developing Enterprise solutions;
                    Computational methods and software; Intelligent data analysis; Computer
                    networks; Modeling processes and systems
                </p>
            </section>
