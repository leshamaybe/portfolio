    ...
    return (
        <div className={s.about}>
            ...
            <p>
                ...
                haven't studied JS and was making sites layout only for fun. Thus, I can say that my
                introduction to frontend began in the summer of 2022.
            </p>
            <p>
                ...
                also to solve everyday problems I encounter, but also to solve everyday problems I
                encounter. When I'm not programming, I'm doing my hobbies, which are: working out,
                partying, meeting people, and self-development in general.
            </p>
        </div>
    );
};
