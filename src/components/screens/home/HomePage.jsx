                ...
                <div className="flex flex-col font-monument uppercase pt-10+10 px-4">
                    <div>
                        <AnimatedText
                            ...
                            className="flex flex-wrap overflow-hidden max-[768px]:text-27+50 min-[3000px]:text-[240px] text-23+72 w-[90%] font-extrabold text-primary-color tracking-tight leading-25+60"
                        />
